...
앉을 때는 몸만 좌판 높이로 올리고 그림자는 바닥에 남긴다. 의자 앞이나 옆에 섰다가 좌판으로 **폴짝 올라앉고**, 일어날 때 그 자리로 폴짝 내려온다
(서서 좌판까지 걸어 들어가거나 좌판에서 바로 걸어 나가면 다리가 의자·책상을 뚫는다). 부르면 먼저 내려온 뒤 온다.
책상에 밀어 넣은 줄 가운데 의자처럼 앞은 책상, 양옆은 다른 의자로 막혀 있으면 **뒤에 섰다가 등받이를 넘어** 높이 뛰어 앉는다
(발이 등받이 꼭대기보다 높게 지나가도록 뛰는 높이를 맞춘다. 등받이 위치·높이는 카탈로그 bbox 의 뒤 끝·꼭대기).
